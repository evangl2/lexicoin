            ...
            <div className="relative z-10 w-full max-w-lg flex flex-col items-center text-center px-6">
                ...
                <AnimatePresence>
                    {step === 'intro' && (
                        ...
                        >
                            <motion.div animate={{ scale: [1, 1.1, 1], opacity: [0.6, 1, 0.6] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}>
                                <Sparkles className="text-amber-400 w-16 h-16 mb-4" />
                            </motion.div>
                    ...
                    {(step === 'echo' || step === 'final') && result.echo && (
                        ...
                        >
                            ...
                            <div className="relative">
                                <motion.div className="absolute inset-0 bg-amber-500/20 blur-3xl rounded-full scale-150" animate={{ opacity: [0.2, 0.5, 0.2], scale: [1.4, 1.6, 1.4] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }} />
