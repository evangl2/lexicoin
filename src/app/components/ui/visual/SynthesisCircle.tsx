...
export const SynthesisCircle: React.FC<SynthesisCircleProps> = React.memo(({
    ...
    return (
        ...
        >
            ...
            >
                {/* Decorative Rings */}
                <motion.div animate={{ rotate: 360, scale: [0.98, 1.02, 0.98] }} transition={{ rotate: { duration: 60, repeat: Infinity, ease: "linear" }, scale: { duration: 8, repeat: Infinity, ease: "easeInOut" } }} className="absolute inset-4 rounded-full border border-dashed border-white/5" />
