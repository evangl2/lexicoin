                        ...
                        <div className="cheat-panel">
                            <section className="cheat-section">
                                ...
                                <div className="cheat-presets">
                                    <button onClick={() => updatePlayer({ stamina: Math.max(0, (stamina || 0) - 10) })}>-10</button>
                                    <button onClick={() => updatePlayer({ stamina: Math.min((maxStamina || 0), (stamina || 0) + 10) })}>+10</button>
                            ...
                            <section className="cheat-section">
                                ...
                                <div className="cheat-presets">
                                    <button onClick={() => {
                                        const currentXP = languageProgress?.[learningLang]?.xp || 0;
