...
import type { FeatureFlagsState } from './slices/featureFlags';
import type {
    PlayerState,
    ViewMode,
    CanvasView,
...
export interface GameStore extends ConfigState, CardState, ProgressionState, GrimoireState, GrimoireActions, PersonaStoryState, FeatureFlagsState {
    // Player State
    player: PlayerState;
